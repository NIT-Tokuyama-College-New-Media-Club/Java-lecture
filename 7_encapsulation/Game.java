...
public class Game {
    private static final int COMMAND_ATTACK         = 1;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (cmd == COMMAND_QUIT) {
                ...
                System.out.println(target.getName() + "に攻撃する");
    ...
    private static Chara selectTarget(Chara[] charas) {
        Scanner sc = new Scanner(System.in);
    ...
    private static void printCurrentActor(Chara chara) {
        System.out.println(chara.getName() + "のターンです");
    }

    private static void printStatus(Chara[] charas) {
